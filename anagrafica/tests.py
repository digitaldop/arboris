...
class FamiliareCurrentDetailViewTests(TestCase):
    ...
    def test_crea_educatore_non_mostra_parentela_generale(self):
        ...
        self.assertTrue(response.context["show_parent_toggle"])
        self.assertFalse(response.context["parent_fields_enabled"])
        self.assertFalse(response.context["show_work_profile_toggle_fields"])
        self.assertFalse(response.context["show_scambio_retta_field"])
        self.assertFalse(response.context["show_contact_formsets"])
        self.assertFalse(response.context["form"].fields["relazione_familiare"].required)
        self.assertIn("studenti_collegati", response.context["form"].fields)
        self.assertContains(response, "Nuovo educatore")
        self.assertContains(response, "Anche genitore")
        self.assertContains(response, "data-relative-parent-field hidden")
        self.assertContains(response, 'name="profilo_educatore_attivo"')
        self.assertContains(response, 'value="on"')
        self.assertContains(response, 'id="id_profilo_educatore_attivo"')
        self.assertContains(response, 'data-work-profile-forced="educatore"')
        self.assertNotContains(response, "Anche dipendente")
        self.assertNotContains(response, "Anche educatore")
        self.assertNotContains(response, "id_abilitato_scambio_retta")
        self.assertNotContains(response, "Recapiti e indirizzi")

    def test_crea_dipendente_non_mostra_parentela_generale(self):
        ...
        self.assertContains(response, "Anche genitore")
        self.assertContains(response, "data-relative-parent-field hidden")
        self.assertContains(response, 'name="profilo_dipendente_attivo"')
        self.assertContains(response, 'value="on"')
        self.assertContains(response, 'id="id_profilo_dipendente_attivo"')
        self.assertContains(response, 'data-work-profile-forced="dipendente"')
        self.assertNotContains(response, "Anche dipendente")
        self.assertNotContains(response, "Anche educatore")
        self.assertNotContains(response, "id_abilitato_scambio_retta")
        self.assertNotContains(response, "Recapiti e indirizzi")
    ...
    def test_crea_familiare_standard_richiede_parentela_generale(self):
        ...
        self.assertFalse(response.context["show_parent_toggle"])
        self.assertTrue(response.context["parent_fields_enabled"])
        self.assertTrue(response.context["show_work_profile_toggle_fields"])
        self.assertTrue(response.context["show_scambio_retta_field"])
        self.assertTrue(response.context["show_contact_formsets"])
        ...
        self.assertContains(response, "Figli e figlie collegati")
        self.assertContains(response, "Recapiti e indirizzi")
