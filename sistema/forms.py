...
class SistemaImpostazioniGeneraliForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            "interfaccia_professionale_attiva",
        ...
        labels = {
            ...
            "interfaccia_colorata_attiva": "Interfaccia colorata",
            "interfaccia_professionale_attiva": "Interfaccia professionale",
            "stile_streamline_attivo": "Stile Streamline",
            "stile_iconscout_3d_attivo": "Stile IconScout 3D",
...
class SistemaRuoloPermessiForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            "accesso_comunicazioni_famiglie": "Comunicazioni alle famiglie",
        ...
        if commit:
            ...
            SistemaUtentePermessi.objects.update_or_create(
                ...
                defaults={
                    ...
                    "accesso_comunicazioni_famiglie": ruolo_permessi.accesso_comunicazioni_famiglie,
